import { getRegisteredChildrenWithGuardianId, getCheckedInChildren } from "../service/ChildService.js";
...
const populateChildDropdown = async () => {
    try {
        ...
        const response = await getCheckedInChildren(payload.accountId); 
